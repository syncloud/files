...
apt-get update
apt-get install -y python-dev build-essential libsasl2-dev libldap2-dev libssl-dev sshpass curl netcat xvfb wget unzip libfontconfig libgtk-3-0 libasound2 libdbus-glib-1-2
